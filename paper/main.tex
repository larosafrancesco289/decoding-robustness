...
temperature. At $T{=}1.5$ Llama's drop is disjoint from the other two models', and at
$T{=}1.7$ Qwen2.5's is disjoint from Gemma's. Within each model the cliff
...
gains more than $+0.0015$. This per-model destabilization ranks the temperature drops
