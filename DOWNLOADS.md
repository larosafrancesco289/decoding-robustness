...
36 files in total: 7 models at 4 quantization levels each, the BF16 anchor on
Qwen3-4B, the two Q8 checkpoints of the two further Llama releases, the four Q8
checkpoints of the 2026 models (served by llama.cpp v0.4.0), and the F16 checkpoint
of Llama-3.2-3B used in the engine check. The engine check's Transformers arms load
the official Hugging Face weights named in the paper's Appendix A, not GGUF files.
...
## 2026 models and the engine-check F16 file

Hashes as published by Hugging Face for each file (the LFS object id is the file's SHA256).

`bartowski/Hermes-3-Llama-3.1-8B-GGUF`

| File | SHA256 |
|---|---|
| Hermes-3-Llama-3.1-8B-Q8_0.gguf | `741d0fd2cdbe38ae2ebea39faf070d475aabb5f8bd60d74d3300302989eedcfb` |

`bartowski/Qwen_Qwen3.5-9B-GGUF`

| File | SHA256 |
|---|---|
| Qwen_Qwen3.5-9B-Q8_0.gguf | `b58fe056b5435070240de259f3f981aa38fee96825bbd78c088d5fd90e46f2b5` |
...
`bartowski/allenai_Olmo-3-7B-Instruct-GGUF`

| File | SHA256 |
|---|---|
| allenai_Olmo-3-7B-Instruct-Q8_0.gguf | `1c46acf59464ab241d7d28209e7553c0793523ec665615c44b5ae072b1755940` |

`bartowski/Llama-3.2-3B-Instruct-GGUF`

| File | SHA256 |
|---|---|
| Llama-3.2-3B-Instruct-f16.gguf | `b5ebe8fbb5ab5f05aaa056948668c5f7443df9d0883497f1d9c05f57fb8ea6cd` |
