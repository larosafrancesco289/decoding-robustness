...
#
# A6000 DROPPED (2026-06-02, user's call): landonia11 is CPU-starved (12 CPU / 8 GPU) and
# contended, so the user runs the VRAM-heavy cells on their own machine instead. Those cells —
...
echo "NOTE: VRAM-heavy cells (cells_a6000.txt + Llama Q8_0) are the user's — run off-cluster."
